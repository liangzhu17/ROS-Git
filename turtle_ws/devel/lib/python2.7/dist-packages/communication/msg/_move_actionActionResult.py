...
"""autogenerated by genpy from communication/move_actionActionResult.msg. Do not edit."""
import codecs
import sys
...
class move_actionActionResult(genpy.Message):
  _md5sum = "955bc302bcd13d4418dda3b1563a5402"
  _type = "communication/move_actionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','communication/move_actionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = communication.msg.move_actionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = communication.msg.move_actionResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.result.total_time_used
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.total_time_used,) = _get_struct_I().unpack(str[start:end])
      return self
