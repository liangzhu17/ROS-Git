...
"""autogenerated by genpy from communication/moveActionResult.msg. Do not edit."""
import codecs
import sys
...
class moveActionResult(genpy.Message):
  ...
  _type = "communication/moveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','communication/moveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = communication.msg.moveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = communication.msg.moveResult()
