...
"""autogenerated by genpy from communication/moveActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class moveActionFeedback(genpy.Message):
  ...
  _type = "communication/moveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','communication/moveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = communication.msg.moveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = communication.msg.moveFeedback()
